...
const ComplaintType = () => {
    ...
    function GetEmployeeData(){
        ...
        let one =
        "http://localhost:4000/complaintTypes";
        let two =
    ...
    const handleSubmite = (e) => {
        e.preventDefault();
        const url = 'http://localhost:4000/complaintTypes'
        const Credentials = { complaintTypeName,category,categoryID }
    ...
    const handleEdit = (e) =>{
        e.preventDefault();
        const url = `http://localhost:4000/complaintTypes/${id}`
        console.log("url:",url)
        console.log("CategoryID:",categoryID)
        const Credentials = { complaintTypeName,categoryID }
    ...
    return (
        <div>
                    ...
                    <Modal.Body>
                        <div>
                            <div className='form-group'>
                                ...
                                <input type="text" className='form-control' value={RowData.complaintTypeName} readOnly />
                            ...
                            {
                                Delete && (
                                    <Button type='submit' className='btn btn-danger mt-4' onClick={handleDelete} >Delete Complaint Type</Button>
                                )
                            }
                    ...
                    <Modal.Body>
                        ...
                        <div>
                            ...
                            <div className='form-group'>
                                ...
                                <input type="text" className='form-control' onChange={(e) => setcomplaintTypeName(e.target.value)} placeholder="Enter Complaint Type" />
                                
                            </div>

                            <Button type='submit' className='btn btn-success mt-4' onClick={handleSubmite}>Add Complaint Type</Button>
                        </div>
            ...
            <div className='model-box-view'>
                ...
                >
                    <Modal.Header closeButton>
                        <Modal.Title>Edit Complaint Type</Modal.Title>
                    </Modal.Header>
                    <Modal.Body>
                        <div>
                            <div className='form-group'>
                                ...
                                <label>Complaint Type</label>
                                <input type="text" className='form-control' onChange={(e) => setcomplaintTypeName(e.target.value)} placeholder="Enter Sector" defaultValue={RowData.complaintTypeName}/>
                            </div>
                            
                            <Button type='submit' className='btn btn-warning mt-4' onClick={handleEdit}>Edit Complaint Type</Button>
