...
const User = () => {
    ...
    const handleSubmite = (e) => {
        ...
        const Credentials = { officerID, username, password, isMoible }
                ...
                <Modal
                    ...
                    <Modal.Body>
                        ...
                        <div>
                            ...
                            <option value={data._id}>{data.officerName}</option>
                            ...
                            <label>Username</label>
                            <input type="text" className='form-control' onChange={(e) => setsectorName(e.target.value)} placeholder="Enter Username" />

                            <label>Password</label>
                            <input type="text" className='form-control' onChange={(e) => setsectorName(e.target.value)} placeholder="Enter Password" />
